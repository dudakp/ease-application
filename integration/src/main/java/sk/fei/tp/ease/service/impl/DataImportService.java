...
public class DataImportService implements IDataImportService {
    ...
    public Object importSingleFile(MultipartFile file) {
        try {
            ...
            log.info("Imported {} rows to DB", numImportedRows.get());
            return null;
